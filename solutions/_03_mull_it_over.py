...
result = sum(eval(instruction) for instruction in find_uncorrupted_mul_instructions(corrupted_memory))
...
result = sum(eval(instruction) for instruction in find_enabled_uncorrupted_mul_instructions(corrupted_memory))
